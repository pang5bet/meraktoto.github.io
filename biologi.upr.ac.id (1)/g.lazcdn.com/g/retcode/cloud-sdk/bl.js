 ! function() {
     ...
     1: [function(e, t, r) {
         var n = e("./util"),
             ...
             s = function(e) {
                 return this.ver = "1.8.30", this._conf = n.ext({}, s.dftCon), this.$a5 = {}, this.$a1 = [], this.$a6 = [], this.sdkFlag = !0, this.hash = n.seq(), this.$a7(), this.setConfig(e), this.rip = n.getRandIP(), this.record = 999, this["EagleEye-TraceID"] = this.getTraceId()["EagleEye-TraceID"], this._common = {}, this
             };
         s.dftCon = {
             sample: 1,
             pvSample: 1,
             ...
             setConfig: function(e) {
                 e && "object" == typeof e && (n.$aa(e), e = this.$ab(e), this._conf = n.ext({}, this._conf, e))
             },
             $ab: function(e) {
                 var t = e.region,
                     r = e.imgUrl;
                 if (t) {
                     var a = n.regionMap[t];
                     return e.imgUrl = a || n.defaultImgUrl, e
                 }
             ...
             $ac: function(e) {
                 ...
                 return !r && n.warn("[retcode] invalid url: " + e), r
             },
             $ad: function() {},
             $ae: function(e) {
             ...
             $a7: function() {
                 this.pageview = n.uu(), this.sBegin = Date.now()
             },
             $ah: function() {
             ...
             getTraceId: function() {
                 ...
                 return this["EagleEye-TraceID"] = a, this.record = r, {
                     "EagleEye-TraceID": a
                 }
             },
             ...
             $ai: function(e) {
                 return 1 === e || ("boolean" == typeof this.$a5[e] ? this.$a5[e] : (this.$a5[e] = n.pick(e), this.$a5[e]))
             },
             $a4: function(e) {
                 var t;
                 clearTimeout(this.$a3), this.$a3 = null;
                 for (var r = this._conf && "function" == typeof this._conf.sendRequest; t = this.$a1.pop();) "res" === t.t ? this.$af(t, "res") : "error" === t.t ? this.$af(t, "err") : "api" === t.t ? this.$af(t, "apiSnapshot") : "behavior" === t.t ? this.$af(t, "behavior") : "health" === t.t && !r && window && window.navigator && "function" == typeof window.navigator.sendBeacon ? this.$ae(t) : this.$ad(t);
                 return e && this.$aj(), this
             },
             $aj: function() {
                 var e;
                 for (clearTimeout(this.$ak), this.$ak = null; e = this.$a6.pop();) this.$af(e, "err");
                 return this
             },
             _lg: function(e, t, r, a) {
                 ...
                 if (n.$al(s, l) || n.$al(n.decode(s), l)) return this;
                 if ("error" === e && (n.$al(t.msg, u) || n.$al(n.decode(t.msg), u))) return this;
                 if ("resourceError" === e && (n.$al(t.src, f) || n.$al(n.decode(t.src), f))) return this;
                 if ("api" === e && (n.$al(t.api, p) || n.$al(n.decode(t.api), p))) return this;
                 if (!this.$ac(i.imgUrl)) return this;
                 if (!t || i.disabled || !i.pid) return this;
                 if (0 === a) return this;
                 var h = t.dl;
                 return delete t.dl, t = n.ext({
                     t: e,
                     times: 1,
                     page: s,
                     tag: i.tag || "",
             ...
             _self: function(e, t, r) {
                 var a = this,
                     o = a._conf;
                 if ("error" !== e) return a;
                 if (!a.$ac(o.imgUrl)) return a;
                 if (!t || o.disabled || !o.pid) return a;
                 if (r && !a.$ai(r)) return a;
                 t = n.ext({
                     t: e,
                     times: 1,
                     page: n.selfErrPage,
                 ...
                 } else a.$a6.unshift(t), a.$a2(function() {
                     a.sdkFlag && (a.sdkFlag = !1, a.$ak = n.delay(function() {
                         a.$aj()
                     }, 1e4))
                 })
             },
             custom: function(e, t) {
                 ...
                 return n.each(e, function(e, t) {
                     return !(r = t && t.length <= 20) && n.warn("[retcode] invalid key: " + t), a["x-" + t] = e, r
         ...
         t.exports = function(e, t) {
             var r = [],
                 ...
                 f = function(e) {
                     ...
                     if (o.push(e.tagName.toLowerCase()), "string" == typeof e.id && o.push("#".concat(e.id)), "string" == typeof(t = e.className))
                         for (r = t.split(/\s+/), i = 0; i < r.length; i++) o.push(".".concat(r[i]));
                     var s = ["type", "name", "title", "alt", "data-arms-attr"];
                     for (i = 0; i < s.length; i++) n = s[i], "string" == typeof(a = e.getAttribute(n)) && o.push("[".concat(n, '="').concat(a, '"]'));
                     return o.join("")
                 },
                 l = function(e, t) {
                     return function(r) {
                                 ...
                                 var i = {
                                     ...
                                     data: {
                                         message: function(e) {
                                             ...
                                             for (var t = e || null, r = [], n = 0, a = 0, i = " > ".length, o = ""; t && n++ < 5 && !("html" === (o = f(t)) || n > 1 && a + r.length * i + o.length >= 80);) r.push(o), a += o.length, t = t.parentNode;
                 ...
                 p = function() {
                     if (function() {
                         ...
                         var e = function(e, t) {
                                 ...
                                 a && a.addBehavior(r), i = t
                             },
                             r = t.onpopstate;
                         t.onpopstate = function() {
                             for (var n = arguments.length, a = new Array(n), o = 0; o < n; o++) a[o] = arguments[o];
                             var s = t.location.href;
                             if (e(i, s), r) return r.apply(this, a)
                         };
                         var n = function(t) {
                             return function() {
                                 for (var r = arguments.length, n = new Array(r), a = 0; a < r; a++) n[a] = arguments[a];
                                 var o = n.length > 2 ? n[2] : undefined;
                                 return o && e(i, String(o)), t.apply(this, n)
                             }
                         };
                         u(t.history, "pushState", n), u(t.history, "replaceState", n)
                     }
                 };
             n.ext(e.prototype, {
                 addBehavior: function(e) {
                     if (this.getConfig("behavior") && e && "object" == typeof e) {
                         ...
                         if (e.type) a = i;
                             ...
                             a.name = i.name.substr(0, 20), a.message = i.message.substr(0, 200)
                         }
                 ...
                 reportBehavior: function(e) {
                     var t = this;
                     t.getConfig("behavior") && (t.$am && (clearTimeout(t.$am), t.$am = undefined), t.$am = setTimeout(function() {
                         r && r.length > 0 && (t.behavior(r), r = [], t.$am = undefined, e && "function" == typeof e && e())
                     }, 0))
                 },
                 $an: function() {
                             ...
                             ! function() {
                                 if (document && document.referrer && document.location) {
                                     ...
                                     if ("" !== e) {
                                         ...
                                         i = t, a && a.addBehavior(r)
                                     }
                                 }
                             }(), t && t.document && t.document.addEventListener && (t.document.addEventListener("click", l("click"), !1), t.document.addEventListener("keypress", l("keypress"), !1)), p(), this.getConfig("enableConsole") && function() {
                                 if (t && t.console)
     ...
     3: [function(e, t, r) {
         var n = e("../util"),
             ...
             f = function(e) {
                 var t = this;
                 return a.call(t, e), t._initialPage = e.page && n.$a9(e.page, [], e.page + "") || null, t._isRobot = n.isRobot(), t._health = {
                     errcount: 0,
                     apisucc: 0,
                     apifail: 0
                 }, t.$ao = function(e, r) {
                     "error" === e ? t._health.errcount++ : "api" === e && t._health[r.success ? "apisucc" : "apifail"]++
                 }, !1 !== e.enableInstanceAutoSend && (t.$ap(), t.$aq(), t.$ar(1e4), t._conf && t._conf.behavior && "function" == typeof t.$an && t.$an()), Object.defineProperty && s.addEventListener && Object.defineProperty(t, "pipe", {
                     set: t.$as
                 }), t
             };
         f.prototype = n.$at(a.prototype), n.ext(a._root.dftCon, {
             uid: null,
             setUsername: null,
             ignoreUrlPath: null,
             ignoreApiPath: null,
             ...
             parseResponse: function(e) {
                 ...
                 return "object" == typeof r && (t = t || r.code, r = r.msg || r.message || r.info || r.ret || JSON.stringify(r)), {
                     msg: r,
                     code: t,
                     success: !0
                 }
             ...
             $a2: function(e) {
                 ...
                 "complete" === c.readyState ? (t.hasReady = !0, e()) : n.on(s, "load", function() {
                     t.hasReady = !0, e()
                 }, !0)
             },
             $a8: function(e) {
             ...
             setPage: function(e, t) {
                 ...
                 if (!1 !== t) {
                     if (!e || e === n) return r;
                     r.$aw = e, clearTimeout(r.$ax), r.$ay(1), r.$a7(), r.$ax = setTimeout(function() {
                         r.$az()
                     }, 10)
                 } else r.$aw = e;
                 return r._conf.page = e, r
             },
             setConfig: function(e, t) {
                 if (e && "object" == typeof e) {
                     n.$aa(e), e = this.$ab(e);
                     var r = this._conf;
                     if (this._conf = n.ext({}, r, e), !t) {
                         var a = "disableHook";
                         a in e && r[a] !== e[a] && (e[a] ? this.removeHook() : this.addHook()), (a = "enableSPA") in e && r[a] !== e[a] && this.$b0(e[a])
                     }
                 }
             },
             $ad: function(e) {
             ...
             $af: function(e, t) {
                 ...
                 r[t] = e[t], delete e[t];
                 var a = "";
                 "object" == typeof e && (a = n.serialize(e)), o(r, this.getConfig("imgUrl") + a + "&post_res=")
             },
             $as: function(e) {
                 var t = this;
                 if (!e || !e.length) return t;
                 try {
                     if ("Array" === n.T(e[0])) return n.each(e, function(e) {
                         return t.$as(e)
                     });
                     if ("Array" !== n.T(e)) return t;
                     var r = e.shift();
                     if (!u.test(r)) return t;
                     t[r].apply(t, e)
                 } catch (a) {
                     return n.warn("[retcode] error in sendPipe", a), t
                 }
             },
             $b1: function() {
         ...
         t.exports = function(e, t, r) {
             function i(e, t, r) {
                 ...
                 if ("SCRIPT" !== a && "STYLE" !== a && "META" !== a && "HEAD" !== a) {
                     ...
                     if (o > 0)
                         for (var c = e.children, u = o - 1; u >= 0; u--) n += i(c[u], t + 1, n > 0);
                     if (n <= 0 && !r) {
             ...
             n.ext(e.prototype, {
                 $ar: function(e) {
                     ...
                     if (!t.MutationObserver) return n.warn("[retcode] first meaningful paint can not be retrieved"), a.$b2(), null;
                 ...
                 $b3: function(e, t) {
                     var r = this;
                     if (u && f)
                         if (r.$b4 && (clearTimeout(r.$b4), r.$b4 = null), t || ! function(e, t) {
                                 var r = Date.now() - e;
     ...
     5: [function(e, t, r) {
         t.exports = function(t, r) {
             var n = e("../util"),
                 ...
                 o = function(e, t) {
                     ...
                     r.CustomEvent ? n = new CustomEvent(e, {
                         detail: t
                     }) : ((n = i.createEvent("HTMLEvents")).initEvent(e, !1, !0), n.detail = t), r.dispatchEvent(n)
                 },
                 s = function(e) {
                     var t = a[e];
             ...
             n.ext(t.prototype, {
                 $b6: function() {
                     return this.$b7 ? this : (s("pushState"), s("replaceState"), this.$b7 = !0, this)
                 }
             })
         }
     }, {
         ...
         t.exports = function(t, r, n) {
             var a = e("../util"),
                 ...
                 g = function(e, t, r, i, o) {
                     ...
                     var u = e + "=" + t;
                     i && (u += "; domain=" + i), u += "; path=" + (o || "/"), r && (u += "; max-age=" + r);
                     try {
                         return n.cookie = u, !!n.cookie
                     } catch (f) {
             ...
             return a.ext(t.prototype, {
                 ...
                 errorHandler: function(e) {
                     ...
                     } else "unhandledrejection" === t && a.T(e.reason, "Error") && a.$b9(e.reason) && this.error(e.reason);
                     try {
                 ...
                 $b8: function(e) {
                     ...
                     try {
                         ...
                         return a.warn("[ARMS] $b8 error :", s), t
                     }
                 },
                 $ba: function(e) {
                     var t = e.src || e.href;
                 ...
                 $b2: function(e) {
                     ...
                     t.$a2(function() {
                         var r = o();
                         r && r.load && r.load > 0 && (r.page = t.$a8(!0), e && (r = a.ext(r, e)), r.autoSend = !0, t.performance(r))
                     })
                 },
                 $bc: function(e) {
                     var t = this;
                     t.$a2(function() {
                         var r = i();
                         r && r.load && r.load > 0 && (r.load && r.load <= 2e3 || r.load && r.load <= 8e3 && Math.random() > .05 || (r.page = t.$a8(!0), r.dl = location.href, e && (r = a.ext(r, e)), t._lg("res", r, t.getConfig("sample"))))
                     })
                 },
                 $az: function() {
                     var e = this;
                 ...
                 $ag: function() {
                     return p.uid = d(this), p.sid = function(e) {
                         if (e.session) return e.session;
                         var t;
                         try {
                             if ("object" == typeof window && "object" == typeof sessionStorage && "function" == typeof sessionStorage.getItem) return "string" == typeof(t = sessionStorage.getItem("_bl_sid")) ? (e.session = t, t) : (t = a.uu(), e.session = t, "function" == typeof sessionStorage.setItem && sessionStorage.setItem("_bl_sid", t), t)
                         } catch (r) {
                             a.warn("[ARMS] getSid error :", r)
                         }
                         return e.session = t = a.uu(), t
                     }(this), p
                 },
                 $ay: function(e) {
                     var t = Date.now();
                     if (t - this._lastUnload < 200) return this;
                     this._lastUnload = t, this.$b1(e), this.$bd && (this._lg("speed", this.$bd), this.$bd = null, clearTimeout(this.$be)), this.$a4(!0)
                 },
                 $b0: function(e) {
                     var t = this;
                     if (!e ^ t.$bf) return t;
                     e ? (t.$b6(), t.$bf = function(e) {
                         var r = t._conf.parseHash(location.hash);
                         r && t.setPage(r, !1 !== e)
                     }, t.$bg = function(e) {
                         var r = t._conf.parseHash(e.detail);
                         r && t.setPage(r)
                     }, a.on(r, "hashchange", t.$bf), a.on(r, "historystatechange", t.$bg), t.$bf(!1)) : (a.off(r, "hashchange", t.$bf), a.off(r, "historystatechange", t.$bg), t.$bf = null, t.$bg = null)
                 },
                 $ap: function() {
                     var e = this;
                     if (e.$bh) return e;
                     ...
                     return a.on(r, "beforeunload", function() {
                         e.$ay(0)
                     }), e.$b0(t.enableSPA), e.activeErrHandler(!1), e.$bh = !0, e
                 }
         ...
         t.exports = function(t, r) {
             ...
             return n.ext(t.prototype, {
                 removeHook: function(e, t) {
                     return a && (t || this === a) ? (r[c] && (r[s] = r[c], delete r[c]), r[u] && (r[f] = r[u], delete r[u]), a = null, this) : this
                 },
                 addHook: function(e) {
                     return !e && a ? this : (a || (function() {
                         if ("function" == typeof r[s]) {
                             var e = r[s];
                             r[c] = e, r[s] = function(t, s) {
                                 var c = 1 === arguments.length ? [arguments[0]] : Array.apply(null, arguments),
                                     u = a;
                                 if (!u || !u.api) return e.apply(r, c);
                                 if (s && ("HEAD" === s.method || "no-cors" === s.mode)) return e.apply(r, c);
                                 var f = Date.now(),
                                     l = u._conf,
                                 ...
                                 if (!n.$bi(p, !0) || n.$al(p, g)) return e.apply(r, c);
                                 ...
                                 if ($ && !u.$ai($) && (_ = 0), d) {
                                     ...
                                     if (u.getConfig("enableApiCors") || S) {
                                         if (t && "string" != typeof t) try {
                                             if (c[0].headers && "function" == typeof c[0].headers.get && "function" == typeof c[0].headers.append) switch (w) {
                                                 case "tracing":
                                                     var T = c[0].headers.get("uber-trace-id");
                                                     T ? v = T.split(":")[0] : (T = u.getUberTraceId(_), c[0].headers.append("uber-trace-id", T["uber-trace-id"]), v = T.traceId), m = u.pageview;
                                                     break;
                                                 default:
                                                     var x = c[0].headers.get("EagleEye-TraceID"),
                                                         I = c[0].headers.get("EagleEye-SessionID"),
                                                         k = c[0].headers.get("EagleEye-pAppName");
                                                     x ? v = x : (v = u.getTraceId()["EagleEye-TraceID"], c[0].headers.append("EagleEye-TraceID", v)), I ? m = I : (m = u.getPageviewId()["EagleEye-SessionID"], c[0].headers.append("EagleEye-SessionID", m)), k || c[0].headers.append("EagleEye-pAppName", y)
                                             }
                                         } catch (D) {
                                             n.warn("[retcode] fetch failed to set header, exception is :\n" + D)
                                         }
                                         if (s) switch (s.headers = s.headers ? s.headers : {}, w) {
                                             case "tracing":
                                                 if (s.headers["uber-trace-id"]) v = s.headers["uber-trace-id"].split(":")[0];
                                                 else {
                                                     var C = u.getUberTraceId(_);
                                                     s.headers["uber-trace-id"] = C["uber-trace-id"], v = C.traceId
                                                 }
                                                 m = u.getPageviewId()["EagleEye-SessionID"];
                                                 break;
                                             default:
                                                 s.headers["EagleEye-TraceID"] ? v = s.headers["EagleEye-TraceID"] : (v = u.getTraceId()["EagleEye-TraceID"], s.headers["EagleEye-TraceID"] = v), s.headers["EagleEye-SessionID"] ? m = s.headers["EagleEye-SessionID"] : (m = u.getPageviewId()["EagleEye-SessionID"], s.headers["EagleEye-SessionID"] = m), s.headers["EagleEye-pAppName"] || (s.headers["EagleEye-pAppName"] = y)
                                         }
                                     }
                                 }
                                 return e.apply(r, c).then(function(e) {
                                     ...
                                     try {
                                         ...
                                         return n.warn("[ARMS] fetch response error :", j), e
                                     }
                                 })["catch"](function(e) {
                                     if (!u || !u.api) throw e;
                                     var t = Date.now() - f;
                                     throw u.api(p, !1, t, e.name || "Error", e.message, f, v, m, {}, i), e
                                 })
                             }, r[s].toString = n.$b5(s)
                         }
                     }(), function() {
                         if ("function" == typeof r[f]) {
                             ...
                             var s = function(r) {
                                 var s = new t(r),
                                     c = a;
                                 if (!c || !c.api || !s.addEventListener) return s;
                                 var u, f, l, p = s.send,
                                     h = s.open,
                                     g = s.setRequestHeader,
                                     d = c._conf,
                                     v = (d.ignore || {}).ignoreApis,
                                     m = c.getConfig("enableLinkTrace"),
                                     y = "",
                                     b = "",
                                     $ = "",
                                     w = null,
                                     _ = c.getConfig("sample"),
                                     E = c.getConfig("linkType"),
                                     S = 1;
                                 return _ && !c.$ai(_) && (S = 0), s.open = function(t, r) {
                                     e = t;
                                     var a = 1 === arguments.length ? [arguments[0]] : Array.apply(null, arguments);
                                     h.apply(s, a), l = r || "", f = n.$av(l);
                                     var i = !n.$bi(f, !0) || n.$al(f, v);
                                     if (f = f ? n.$au(f, d.ignoreApiPath ? d.ignoreApiPath : d.apiHelper) : "", !i && m) {
                                         var o = "";
                                         try {
                                         ...
                                         if ((c.getConfig("enableApiCors") || u) && g && "function" == typeof g) switch (E) {
                                             case "tracing":
                                                 var p = c.getUberTraceId(S);
                                                 g.apply(s, ["uber-trace-id", p["uber-trace-id"]]), y = p.traceId, b = c.getPageviewId()["EagleEye-SessionID"];
                                                 break;
                                             default:
                                                 y = c.getTraceId()["EagleEye-TraceID"], g.apply(s, ["EagleEye-TraceID", y]), b = c.getPageviewId()["EagleEye-SessionID"], g.apply(s, ["EagleEye-SessionID", b]), $ = c.getConfig("pid"), g.apply(s, ["EagleEye-pAppName", $])
                                         }
                                     }
                                 }, s.send = function() {
                                     u = Date.now();
                                     ...
                                     if (f && 4 === s.readyState) {
                                         ...
                                         if (!y) {
                                             ...
                                             "object" == typeof a && a["eagleeye-traceid"] && (y = a["eagleeye-traceid"], w = "response")
                                         }
                                         ...
                                         } else c.api(f, !1, t, s.status || "FAILED", s.statusText, u, y, b, r, i, w, S)
                                     }
                                 }), s
                             };
                             s.prototype = t.prototype, r[f] = s, r[f].toString = n.$b5(f)
                         }
                     }()), a = this, this)
                 },
                 $aq: function() {
                     return this.$bj ? this : (this.getConfig("disableHook") || this.addHook(), this.$bj = !0, this)
                 }
             }), t
         }
     }, {
     ...
     9: [function(e, t, r) {
         ...
         t.exports = function() {
             ...
             if ((l = l > 999 ? 999 : l) && (r.bandwidth = l), r.navtype = 1 === f.type ? "Reload" : "Other", 1 === s && i[a[16]] > 0 && i[a[1]] > 0) {
                 var p = i[a[16]] - i[a[1]];
                 p >= 0 && p < 36e5 && (r.fpt = p)
             }
             return 1 === s && i[a[1]] > 0 ? r.begin = i[a[1]] : 2 === s && r.load > 0 ? r.begin = o - r.load : r.begin = o, r
         }
     }, {
         "../util": 16,
         "./constants": 8
     ...
     10: [function(e, t, r) {
         ...
         i = "function" == typeof i ? i : undefined, t.exports = function(e, t) {
             try {
                 var r = new i;
                 r.open("POST", t, !0), r.setRequestHeader("Content-Type", "text/plain"), r.send(JSON.stringify(e))
             } catch (a) {
     ...
     11: [function(e, t, r) {
         ...
         t.exports = function() {
             ...
             if (r.begin = i[a[1]] || Date.now(), "function" == typeof e.PerformanceNavigationTiming) {
     ...
     13: [function(e, t, r) {
         ...
         i = "function" == typeof i ? i : undefined, t.exports = function(e, t) {
             var r = -1;
             "object" == typeof e && (r = e.z, e = n.serialize(e));
             var o = t + e;
             if (i) return i(o, {
                 method: "HEAD",
                 mode: "no-cors"
     ...
     14: [function(e, t, r) {
         ...
         function n(e, t) {
             ...
             r.$as(t);
             var n = r._conf;
             return !1 !== n.autoSendPv && r.$az(), n && n.useFmp || r.$b2(), n && n.sendResource && r.$bc(), a[s] = !0, r
         }
         var a = window,
         ...
         i.singleton = function(e, t) {
             ...
             var t = new i(e),
                 r = t._conf;
             return r.enableInstanceAutoSend && (!1 !== r.autoSendPv && t.$az(), r && r.useFmp || t.$b2(), r && r.sendResource && t.$bc()), t
         };
         "object" == typeof window && !!window.navigator && a[o] && (i.bl = function() {
             if (a[s]) return a[o];
             var e = {},
                 t = [];
             return o in a && (e = a[o].config || {}, t = a[o].pipe || []), n(e, t)
     ...
     15: [function(e, t, r) {
         ...
         s.prototype = n.$at(a.prototype), n.ext(a.dftCon, {
             startTime: null
         }), n.ext(s.prototype, {
             constructor: s,
             _super: a,
             ...
             error: function(e, t) {
                 if (!e) return n.warn("[retcode] invalid param e: " + e), this;
                 ...
                 if (n.$bl(a, t.filename)) {
                     var s = /^Script error\.?$/,
                         c = e.msg || e.message;
                     if (n.$al(c, s) || n.$al(n.decode(c), s)) return this;
                     var u = {
                         msg: n.selfErrKey,
                         err: {
                 ...
                 return n.$al(f.msg, g) || n.$al(n.decode(f.msg), g) ? this : (this.$ao && this.$ao("error", f), this._lg("error", f, 1))
             },
             behavior: function(e) {
                 if (e) {
                     ...
                     return this.$ao && this.$ao("behavior", t), this._lg("behavior", t, 1)
                 }
             },
             api: function(e, t, r, a, o, s, c, u, f, l, p, h) {
                 if (!e) return n.warn("[retcode] api is null"), this;
                 if (e = "string" == typeof e ? {
                         ...
                         domain: l,
                         flag: h
                     } : n.sub(e, i), !n.$bi(e.api, !0)) return this;
                 e.code = e.code || "";
                 var g = e.msg || "";
                 if (g = "string" == typeof g ? g.substring(0, 1e3) : g, e.msg = g, e.success = e.success ? 1 : 0, e.time = +e.time, e.begin = e.begin, e.traceId = e.traceId || "", e.pv_id = e.pv_id || "", e.domain = e.domain || "", e.flag = e.flag, e.dl = "object" == typeof location && "string" == typeof location.href && location.href.substring(0, 500) || "", e.success ? e.apiSnapshot && delete e.apiSnapshot : e.apiSnapshot = f, p && (e.traceOrigin = p), !e.api || isNaN(e.time)) return n.warn("[retcode] invalid time or api"), this;
                 var d = (this.getConfig("ignore") || {}).ignoreApis;
                 return n.$al(e.api, d) || n.$al(n.decode(e.api), d) ? this : (this.$ao && this.$ao("api", e), this._lg("api", e, e.success && this.getConfig("sample"), e.flag))
             },
             speed: function(e, t, r) {
                 var a = this,
                     i = this.getConfig("startTime") || this._startTime;
                 return /^s(\d|1[0])$/.test(e) ? (t = "number" != typeof t ? Date.now() - i : t >= i ? t - i : t, a.$bd = a.$bd || {}, a.$bd[e] = t, a.$bd.begin = i, clearTimeout(a.$be), a.$be = setTimeout(function() {
                     r || (a.$bd.page = a.$a8(!0)), a._lg("speed", a.$bd), a.$bd = null
                 }, 5e3), a) : (n.warn("[retcode] invalid point: " + e), a)
             },
             performance: function(e) {
                 if (e && "object" == typeof e && !this.$bn) {
                     ...
                     if (e.autoSend && a) return r = n.ext(this.$bo || {}, e), this.$bn = !0, this._lg("perf", r, this.getConfig("sample"));
                     if (e.autoSend && !a) return delete e.autoSend, this.$bo ? (r = n.ext(this.$bo || {}, e), this.$bn = !0, this._lg("perf", r, this.getConfig("sample"))) : void(this.$bo = e);
                     for (var i in e)(/^t([1-9]|1[0])$/.test(i) || "ctti" === i || "cfpt" === i) && (t[i] = e[i]);
                     if (!0 === e.autoSend || !a && (a || this.$bo)) return !0 !== e.autoSend && !1 === a && this.$bo ? (t = n.ext(this.$bo || {}, t), this.$bn = !0, this._lg("perf", t, this.getConfig("sample"))) : void 0;
                     this.$bo = n.ext(this.$bo || {}, t)
                 }
             },
             resource: function(e, t) {
                 if (!e || !n.isPlainObject(e)) return n.warn("[arms] invalid param data: " + e), this;
                 var r = Object.keys(e),
                 ...
                 if (i) return n.warn("[arms] lack param data: " + e), this;
                 var s = {
             ...
             event: function(e, t) {
                 if ("object" == typeof e && e && e.key) {
                     ...
                     for (var a in e) n.indexOf(a) > -1 && (r[a] = e[a]);
             ...
             i = {
                 ...
                 $al: function(e, t) {
                     ...
                     for (var r, n = [], a = 0, i = t.length; a < i; a++)
                         if (r = t[a], this.isString(r)) n.push(r.replace(/([.*+?^=!:${}()|\[\]\/\\])/g, "\\$1"));
                         else if (r && r.source) n.push(r.source);
                     else if (r && "Function" === this.T(r) && !0 === this.$a9(r, [e], !1)) return !0;
                 ...
                 $aa: function(e) {
                     if ("sample" in e) {
                         var t = e.sample,
                             r = t;
                         t && /^\d+(\.\d+)?%$/.test(t) && (r = parseInt(100 / parseFloat(t))), 0 < r && 1 > r && (r = parseInt(1 / r)), r >= 1 && r <= 100 ? e.sample = r : delete e.sample
                     }
                     return e
                 },
                 on: function(e, t, r, n, a) {
                     return e.addEventListener ? (a = a || !1, e.addEventListener(t, function i(o) {
                         n && e.removeEventListener(t, i, a), r.call(this, o)
                     }, a)) : e.attachEvent && e.attachEvent("on" + t, function o(a) {
                         n && e.detachEvent("on" + t, o), r.call(this, a)
                     }), this
                 },
                 off: function(e, t, r) {
                 ...
                 uu: function() {
                     for (var e, t, r = 20, n = new Array(r), a = Date.now().toString(36).split(""); r-- > 0;) t = (e = 36 * Math.random() | 0).toString(36), n[r] = e % 3 ? t : t.toUpperCase();
                     for (var i = 0; i < 8; i++) n.splice(3 * i + 2, 0, a[i]);
                     return n.join("")
                 },
                 seq: function() {
                 ...
                 getXhrSnapshot: function(e, t, r) {
                     ...
                     try {
                         var i = "";
                         "" === r.responseType || "text" === r.responseType ? i = r.responseText : "document" === r.responseType && (i = r.responseXML), n = {
                             originApi: e,
                             method: t,
                 ...
                 joinRegExp: function(e) {
                     for (var t, r = [], n = 0, a = e.length; n < a; n++) t = e[n], this.isString(t) ? r.push(t.replace(/([.*+?^=!:${}()|\[\]\/\\])/g, "\\$1")) : t && t.source && r.push(t.source);
