        ...
        NEW_ACTION = function() {
            ! function(e) {
                ...
                function o(e, t, n) {
                    if (e) {
                        ...
                        if (i === +i)
                            ...
                            for (o in e)
                                if (e.hasOwnProperty(o) && t.call(n, e[o], o, e) === !1) break
                    }
                }
                ...
                t.each = o, t.hasClass = i, t.addClass = r, t.removeClass = a, t.toggleClass = function(e, t) {
                    ...
                    if (t = t || p, n = n || "*", p.getElementsByClassName) return t.getElementsByClassName(e);
                ...
                t.getClientRect = function(e) {
                    ...
                    if (p.documentElement.scrollLeft, e.getBoundingClientRect) {
                ...
                t.decorator = m, t.mix = function(e) {
                ...
                }, t.getElementLeft = s, t.getElementTop = l, t.getNCPunish = d
            }, function(e, t, n) {
                "use strict";
                var o = n(2),
                    i = {
                ...
                var i = (n(3).URL_MAP, "//cf.aliyun.com/scratchCardSlide/dataReport.jsonp"),
                    r = window;
                t.log = function(e, t) {
                    var n, r, a = t || i,
                ...
                function o(e, t) {
                    this.id = function(e) {
                        ...
                        if (t instanceof Array)
                            for (o = 0, i = t.length; o < i; o++) this.extend(e, t[o], n);
                ...
                "string" == typeof o && (o = [
                    [e.i, o, ""]
                ]), n(10)(o, {}), o.locals && (e.exports = o.locals)
            }, , , , , , , , , , , , , , , , , , , , , , , function(e, t, n) {
                "use strict";
                var o = window,
                    i = n(2);
                ...
                Object.getPrototypeOf || (Object.getPrototypeOf = function(e) {
                    ...
                    function() {
                        ...
                        var o, i = arguments[1];
                        for (o = 0; o < n; o++)
                            if (o in t && !e.call(i, t[o], o, t)) return !1;
                        return !0
                ...
                "use strict";
                var o, i, r = "//g.alicdn.com/sd/ncpc/nc.css",
                ...
                ! function(e) {
                    ...
                    if (!e[t]) {
                        ...
                        c.v = o, r.init = function() {}, a.has_pointman && (r.noCaptcha = c, pointman.define("nc", function() {
                            return r
                        })), e.noCaptcha = c
                    }
                }(window)
                ...
                function o(e, t, n) {
                    ...
                    return k.prototype = {
                        ...
                        refreshCode: function() {
                            ...
                            e.className = "omeo-code-state", e.innerHTML = "", i.__progtid && clearInterval(i.__progtid), m(o + "omeo-code-key").value = "", this.resetPlayer({
                                state: "playing"
                            }), this.playAudio(), f = g = (new Date).getTime()
                        },
                        switchCode: function(e) {
                            "img" == e.type ? (this.stopAudio(), m(o + "omeo-code").className = "omeo-code omeo-img-active") : (m(o + "omeo-code").className = "omeo-code omeo-audio-active", this.resetPlayer({
                                state: "playing"
                            }), !this.audioSupport || p || (m(o + "omeo-refresh-audio").style.display = ""), this.playAudio()), this.cache.checkState = "notstart", this.cache.checkedCode = null;
                            var t;
                        ...
                        playAudio: function(e) {
                            function t(t) {
                                ...
                                var c;
                                if (this.audioSupport) this.cache.audio = new Audio, c = r.createElement("source"), c.type = n, c.src = e, this.cache.audio.appendChild(c), this.cache.audio.load(), this.cache.audio.play(), this.bindAudioProgress();
                                else if (this.isIE) {
                                    var s = r.createElement("bgsound");
                                    s.setAttribute("id", "omeo-bgsound-audio" + a), s.setAttribute("autostart", "true"), s.setAttribute("src", e), h.appendChild(s), this.cache.audioPlayer = m(o + "omeo-bgsound-audio" + a), this.resetPlayer({
                                        state: "playing"
                                    });
                                    var l = 0,
                                        d = this;
                            ...
                            if (n.cache.checkState = "checking", /^[a-z0-9]{4,6}$/gi.test(e.code)) {
                                ...
                                s += "&" + d.obj2param(l), i[c] = function(t) {
                                    ...
                                    if (t.success && 100 == t.result.code) {
                                        n.cache.checkedCode = e.code, r.className = "omeo-code-state omeo-code-state-success", r.innerHTML = "", n.cache.checkState = "success", i = {
                                            message: "success"
                                        };
                                    ...
                                    }, 3e3), n.cache.checkState = "codeError", i = {
                                        message: "error"
                                    }, m(o + "omeo-code-key").select(), "true" == t.refresh && n.refreshCode();
                                ...
                                var e = m(o + "omeo-code-state");
                                e && (e.className = "", e.innerHTML = "", e = m(o + "omeo-code-key"), e.value = "", e.focus(), n.resetPlayer({
                                    state: "playing"
                                }), n.playAudio())
                            }, 5e3)
                        },
                        ...
                        var u = function(e) {
                            ...
                            if (n && n.length) {
                                ...
                                for (i = 0; i < n.length; i++)
                                    if (n[i].apply(null, a) === !1) return !1
                            }
                        };
                ...
                function makeNoCaptcha(module_nc, opt, inn_vars, nc_events, Scale, onNCEvent, _) {
                    ...
                    function showError(e, t) {
                        ...
                        if (e) {
                            if (n = language[opt.language]._errorNetwork + o, "function" == typeof opt.errorCallback) try {
                                opt.errorCallback(t)
                            } catch (i) {}
                        } else n = language[opt.language]._errorLOADING + o;
                        n = n.replace("%TOKEN", opt.token), n = _upResetIndex(n), _.id(opt.renderTo).innerHTML = '<div class="errloading"><i class="nc_iconfont icon_warn">' + icon_warn + "</i>" + n + "</div>", el_render_to && util.removeClass(el_render_to, "show-click-captcha")
                    }
                    ...
                    return NoCaptcha.prototype = {
                        init: function(e) {
                            ...
                            e.foreign && (t = "en", default_opt.language = t), "CF_APP_WAF" != e.appkey || e.foreign && 0 != e.foreign || (e.apimap = {
                            ...
                            }), _.objUpdate(opt, default_opt), _.objUpdate(opt, e), opt.token || (opt.token = default_opt.token), this.opt = opt;
                            var n;
                            try {
                            ...
                            if (util.getNCPunish(e, "init monitor"), win.MutationObserver && n) {
                                var i = function(t, o) {
                                        var i = n && n.innerHTML ? n.innerHTML.replace(/[ \r\n\"<\/div>]/g, "") : "null";
                                        util.getNCPunish(e, i), r.disconnect()
                                    },
                            ...
                            if (language[opt.language] || (opt.language = t), e.upLang)
                                for (var s in e.upLang) _upLang(s, e.upLang[s]);
                            ...
                            if (opt.logo && css.insertCSS(".nc-container .nc_scale .scale_text {background-image: url(" + NC_LOGO_URL + "); background-repeat: repeat-x;}"), opt.cssUrl)
                                if (doc.createStyleSheet) doc.createStyleSheet(opt.cssUrl);
                                    ...
                                    u.type = "text/css", u.rel = "stylesheet", u.className = "nc-custom-style-" + nc_index, u.href = inn_vars.has_pointman ? util.addHourStamp(opt.cssUrl) : opt.cssUrl;
                        ...
                        initializationReport: function() {
                            ...
                            o.parentNode.insertBefore(n, o), window[e] = function(e) {}, n.src = t
                        },
                        netErrorReport: function(e) {
                            try {
                                if (this.netErrorReported) return;
                                ...
                                i.parentNode.insertBefore(o, i), window[t] = function(e) {}, o.src = n
                            } catch (r) {}
                        },
                        ...
                        loadJS: function() {
                            var e = this;
                            e.opt.timeout = e.opt.timeout || 1e4, window.AWSC ? (e.loadUAB(), e.loadUM()) : _.loadjs(util.addHourStamp(ajaxURL.awsc_Url), function(t) {
                                t ? (showError(!0, ERR_CODE_AWSCTIMEOUT), e.netErrorReport(ERR_CODE_AWSCTIMEOUT)) : (e.loadUAB(), e.loadUM())
                        ...
                        loadUAB: function() {
                            ...
                            UA_Opt.Token = (new Date).getTime() + ":" + opt.token, e.__uab ? e.jsReady() : (e.initUaParam(), AWSC.use("uab", function(t, n) {
                                "loaded" === t ? (e.__uab = n, e.jsReady()) : (showError(!0, ERR_CODE_UABTIMEOUT), e.netErrorReport(ERR_CODE_UABTIMEOUT))
                            }, {
                        ...
                        loadUM: function() {
                            var e = this;
                            window._umopt_npfp = 1, opt.appkey && 0 === opt.appkey.indexOf("X82Y") && (window._umopt_npfp = 0), window._umopt_cris = 0, e.__um ? e.jsReady() : AWSC.use("um", function(t, n) {
                                if ("loaded" === t) {
                                    var o = function r() {
                                        var t = location.href || "";
                                    ...
                                    var i = 0;
                                    o()
                                } else showError(!0, ERR_CODE_UMTIMEOUT), e.netErrorReport(ERR_CODE_UMTIMEOUT)
                            }, {
                                timeout: e.opt.timeout
                            })
                        },
                            ...
                            _.addHandler(t, "keydown", function o(e) {
                                ...
                                function o(t) {
                                    function o(e) {
                                        ...
                                        } else 300 != e.result.code && 69634 != e.result.code || (report("block"), _.id(opt.renderTo).innerHTML = '<div class="errloading"><i class="nc_iconfont icon_warn">' + icon_warn + "</i>" + _upResetIndex(language[opt.language]._error300).replace("<a href", "<a id=" + nc_prefix + "refresh1 href") + "</div>", onNCEvent(event_names.error), onNCEvent(event_names.error300));
                                ...
                                e = !0, i.style.display = "block", objCheckCode && (objCheckCode.resetPlayer({
                                    state: "end"
                                }), objCheckCode.switchCode({
                                    type: "audio"
                                }));
                        ...
                        onScaleReadyCallback: function(e, t) {
                            if (e.success) {
                                var n = e.result,
                                    o = n.code;
                                if (0 === o) _.id(scale_btn).className = "nc_iconfont btn_ok", _.id(scale_btn).innerHTML = icon_ok_sign, TEXTELEM.innerHTML = language[opt.language]._yesTEXT, util.removeClass(t.btn.parentNode, "nc_err"), this.userCallback(n.csessionid, "pass", n.value);
                                else if (UA_Opt.reload && (UA_Opt.Token = (new Date).getTime() + ":" + opt.token, UA_Opt.reload && UA_Opt.reload()), util.addClass(t.btn, "nc_iconfont btn_warn"), util.addClass(t.btn.parentNode, "nc_err"), t.btn.innerHTML = icon_warn, t.bar = _.tag(scale_bar + " div")[0], TEXTELEM.innerHTML = language[opt.language]._Loading + loading_circle_html, "function" == typeof opt.verifycallback && 300 != o && opt.verifycallback(n), 100 == o) this.__inn = 1, this.onScale100(n.csessionid, n.value);
                                else if (200 == o) this.__inn = 1, this.onScale200(n.csessionid, n.value);
                                else if (260 == o) this.onScale260(n.csessionid, n.value);
                                    ...
                                    if (util.removeClass(inn_vars.TEXTELEM, "nc-align-center"), _.id(opt.renderTo).innerHTML = '<div class="errloading"><i class="nc_iconfont icon_warn">' + icon_warn + "</i>" + _upResetIndex(language[opt.language]._error300).replace("<a href", "<a id=" + nc_prefix + "refresh1 href") + "(error:" + r + ")</div>", "function" == typeof opt.failCallback) try {
                                        opt.failCallback(r)
                                    } catch (a) {}
                                            ...
                                            _.addHandler(g, "click", function(e) {
                                                util.addClass(inn_vars.TEXTELEM, "nc-align-center"), TEXTELEM.innerHTML = language[opt.language]._Loading + loading_circle_html, _.jsonp({
                                                    ...
                                                    success: function(e) {
                                                        ...
                                                        if (e.success)
                                                            if (100 == e.result.code) o.className = "nc_iconfont btn_ok", o.innerHTML = icon_ok_sign, util.addClass(inn_vars.TEXTELEM, "nc-align-center"), _.tag(scale_bar + " div")[0].className = "nc_bg", TEXTELEM.innerHTML = language[opt.language]._yesTEXT, util.removeClass(o.parentNode, "nc_err"), _.toggle(nc_prefix + "clickCaptcha"), el_render_to && util.removeClass(el_render_to, "show-click-captcha"), r.userCallback && r.userCallback(t, n, e.result.sig);
                                                            else if (900 == e.result.code) {
                                    ...
                                    _.jsonp({
                                        ...
                                        success: function(t) {
                                            if (t.success) {
                                                ...
                                                } else 300 != t.result.code && 69634 != t.result.code || (report("block"), _.id(opt.renderTo).innerHTML = '<div class="errloading"><i class="nc_iconfont icon_warn">' + icon_warn + "</i>" + _upResetIndex(language[opt.language]._error300).replace("<a href", "<a id=" + nc_prefix + "refresh1 href") + "</div>", onNCEvent(event_names.error), onNCEvent(event_names.error300))
                        ...
                        destroy: function() {
                            ...
                            if (util.getElementsByClassName("nc-required-js-" + nc_index), e = o.length, e > 0)
                                for (t = 0; t < e; t++) n = o[0].parentNode, n && n.removeChild(o[0])
                        }
                    }, NoCaptcha
                }
                var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
                    ...
                    win = window,
                    doc = document,
                    tb_login, util = __webpack_require__(2),
                        ...
                        init: function(t) {
                            function o(o) {
                                ...
                                function f() {
                                    ...
                                    t < y && (c.addClass(s.btn, "button_move"), c.addClass(e.id(u + "_bg"), "bg_move"), s.btn.style.left = "0px", s.ondrag(0, 0), setTimeout(function() {
                ...
                function o(e) {
                    ...
                    function r(e, t) {
                        ...
                        for (n = 0; n < r.length; n++)
                            if (o = r[n], i = o.className, i && i.indexOf(t) > -1) return o;
                        return null
                    }
                    ...
                    Scrape = function() {
                        function Scrape(e) {
                            ...
                            if (t.foreign && (n.language = n.language || "en"), this.options = util.mix({}, cfg.default_options, n, e.options || {}, t), this._last_x = -1, this._last_y = -1, this.stroke_size = t.stroke_size || cfg.default_stroke_width, this.svr_data = {}, this._t_action = null, this.is_downgraded = !1, this._lang = language[this.options.language] || language.cn, this.options.upLang)
                                for (var o in this.options.upLang) this._lang = replaceLang(o, this.options.upLang[o]);
                        ...
                        return _createClass(Scrape, [{
                            ...
                            value: function() {
                                ...
                                l.src = this.options.bg_front, l.onload = function() {
                                    ...
                                    for (var e = l.naturalWidth ? [l.naturalWidth, l.naturalHeight] : [l.width, l.height], t = _slicedToArray(e, 2), i = t[0], r = t[1], a = Math.ceil(o.width / i), c = Math.ceil(o.height / r), s = 0; s < c; s++)
                                        for (var d = 0; d < a; d++) n.drawImage(l, d * i, s * r);
                            ...
                            value: function(e, t) {
                                ...
                                if ((e > .9 || n) && window.__sc__uab.isReadyForSC(window.__sc_uaboption.mIDs)) this.verify();
                                else if (e > .9 && n) {
                                    try {} catch (o) {}
                                    win._n_bak = win._n;
                ...
                function o(e, t, n) {
                    ...
                    var r = void 0,
                        a = l[e.foreign] || l[0];
                    a = s.mix(a, e.apimap), UA_Opt.LogVal = "_n", d.init(e), UA_Opt.sendMethod = 8, UA_Opt.Token = (new Date).getTime() + ":" + e.token, s.loadScript(s.addHourStamp(a.awsc_Url), function(t) {
                        if (AWSC) {
                            var n = function() {
                                if (window.__sc__uab) {
                                    if (clearInterval(i), "timeout" === window.__sc__uab) return void o(u);
                                    o(t)
                                }
                            };
