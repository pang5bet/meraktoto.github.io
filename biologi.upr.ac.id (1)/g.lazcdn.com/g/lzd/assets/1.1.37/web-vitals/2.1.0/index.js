var webVitals = function(e) {
    ...
    var t, n, i, r, a = function(e, t) {
        ...
        p = function(e, t) {
            var n, i = d(),
                ...
                m = f ? null : o("paint", u);
            (f || m) && (n = s(e, r, t), f && u(f), c((function(i) {
    ...
    return e.getCLS = function(e, t) {
        ...
        var n, i = function(t) {
            ...
            v = function(e) {
                if (!e.hadRecentInput) {
                    var t = m[0],
                        i = m[m.length - 1];
                    f && e.startTime - i.startTime < 1e3 && e.startTime - t.startTime < 5e3 ? (f += e.value, m.push(e)) : (f = e.value, m = [e]), f > r.value && (r.value = f, r.entries = m, n())
                }
            },
            d = o("layout-shift", v);
        d && (n = s(i, r, t), u((function() {
        ...
        var f, m = d(),
            v = a("FID"),
            p = function(e) {
                e.startTime < m.firstHiddenTime && (v.value = e.processingStart - e.startTime, v.entries.push(e), f(!0))
            },
            l = o("first-input", p);
        f = s(e, v, i), l && u((function() {
            l.takeRecords().map(p), l.disconnect()
        }), !0), l && c((function() {
            var o;
            v = a("FID"), f = s(e, v, i), r = [], n = -1, t = null, L(addEventListener), o = p, r.push(o), E()
        }))
        ...
        var n, i = d(),
            ...
            m = o("largest-contentful-paint", f);
        if (m) {
            n = s(e, r, t);
            var v = function() {
                w.has(r.id) || (m.takeRecords().map(f), m.disconnect(), w.add(r.id), n(!0))
            };
            ["keydown", "click"].forEach((function(e) {
                ...
                r = a("LCP"), n = s(e, r, t), requestAnimationFrame((function() {
                    requestAnimationFrame((function() {
                        r.value = performance.now() - i.timeStamp, w.add(r.id), n(!0)
                    }))
                }))
            }))
        }
